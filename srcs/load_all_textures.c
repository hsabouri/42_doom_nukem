...
t_img	*load_all_textures(t_game *game)
{
	...
	textures[5] = parse_tga("./textures/multi_sprite/1.tga", 0);
	textures[6] = parse_tga("./textures/multi_sprite/2.tga", 0);
	textures[7] = parse_tga("./textures/multi_sprite/3.tga", 0);
	textures[8] = parse_tga("./textures/multi_sprite/4.tga", 0);
	textures[9] = parse_tga("./textures/multi_sprite/5.tga", 0);
	textures[10] = parse_tga("./textures/multi_sprite/6.tga", 0);
	textures[11] = parse_tga("./textures/multi_sprite/7.tga", 0);
	textures[12] = parse_tga("./textures/multi_sprite/8.tga", 0);
