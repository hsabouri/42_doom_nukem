...
t_img	*load_all_textures(t_game *game)
{
	...
	textures[46] = parse_tga("./textures/ennemies/black_marine/black_marine0.tga", 0);
	textures[47] = parse_tga("./textures/ennemies/black_marine/black_marine1.tga", 0);
	textures[48] = parse_tga("./textures/ennemies/black_marine/black_marine2.tga", 0);
	textures[49] = parse_tga("./textures/ennemies/black_marine/black_marine3.tga", 0);
	textures[50] = parse_tga("./textures/ennemies/black_marine/black_marine4.tga", 0);
	textures[51] = parse_tga("./textures/ennemies/black_marine/black_marine5.tga", 0);
	textures[52] = parse_tga("./textures/ennemies/black_marine/black_marine6.tga", 0);
	textures[53] = parse_tga("./textures/ennemies/black_marine/black_marine7.tga", 0);
