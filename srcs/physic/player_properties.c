...
t_game	player_properties(t_game game, t_event events)
{
	...
	n_game = game;
	n_game.player.my_entity.physic.speed_max.x = (events.keys[SDL_SCANCODE_LSHIFT] &&
		!events.keys[SDL_SCANCODE_LCTRL]) ? 2 : 1;
	n_game.player.my_entity.physic.speed_max.y = (events.keys[SDL_SCANCODE_LSHIFT] &&
		!events.keys[SDL_SCANCODE_LCTRL]) ? 2 : 1;
	n_game.player.my_entity.physic.speed_max.z = game.player.my_entity.physic.speed_max.z;
