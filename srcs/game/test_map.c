...
/*   Updated: 2019/01/23 13:35:42 by hsabouri         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_game	generate_map(t_game game)
{
	...
	walls[12] = ((t_wall){1, 10, 11, &materials[1]});
	walls[13] = ((t_wall){-1, 11, 8, &materials[1]});
	walls[14] = ((t_wall){1, 10, 11, &materials[1]});
	walls[15] = ((t_wall){-1, 11, 12, &materials[1]});
	walls[16] = ((t_wall){2, 12, 13, &materials[1]});
	walls[17] = ((t_wall){-1, 13, 10, &materials[1]});
	walls[18] = ((t_wall){2, 12, 13, &materials[1]});
	walls[19] = ((t_wall){-1, 13, 14, &materials[1]});
	walls[20] = ((t_wall){3, 14, 15, &materials[1]});
	walls[21] = ((t_wall){-1, 15, 12, &materials[1]});
	...
	walls[28] = ((t_wall){-1, 19, 14, &materials[5]});
