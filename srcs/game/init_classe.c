...
t_entity		*init_classe(t_game *game, t_array *multi_mats)
{
	...
	classe[1] = classe_2(GREEN_KEY_CARD, &multi_mats[1], 0, 0.4);
	...
	classe[5] = classe_2(BLUE_KEY_CARD, &multi_mats[5], 0, 0.4);
	classe[6] = classe_2(RED_KEY_CARD, &multi_mats[6], 0, 0.4);
	classe[7] = classe_2(PURPLE_KEY_CARD, &multi_mats[7], 0, 0.4);
	...
	classe[12] = classe_2(AMMO, &multi_mats[12], 3, 0.4);
	classe[13] = classe_2(CLOSE_RED, &multi_mats[13], 3, 0.4);
	classe[14] = classe_2(CLOSE_BLUE, &multi_mats[14], 3, 0.4);
	classe[15] = classe_2(CLOSE_GREEN, &multi_mats[15], 3, 0.4);
	classe[16] = classe_2(CLOSE_PURPLE, &multi_mats[16], 3, 0.4);
	classe[17] = classe_2(OPEN_RED, &multi_mats[17], 3, 0.4);
	classe[18] = classe_2(OPEN_BLUE, &multi_mats[18], 3, 0.4);
	classe[19] = classe_2(OPEN_GREEN, &multi_mats[19], 3, 0.4);
