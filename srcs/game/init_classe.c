...
static t_entity	classe_2(t_entity_type type, t_array *mats, t_vec3 v)
{
	t_entity	classe;
...
t_entity		*init_classe(t_game *game, t_array *multi_mats)
{
	...
	classe[24] = classe_2(PLANT_2, &multi_mats[24], (t_vec3){0, 0.4, 0.5});
	classe[25] = classe_2(PLANT_3, &multi_mats[25], (t_vec3){0, 0.4, 0.9});
	classe[26] = classe_2(PLANT_4, &multi_mats[26], (t_vec3){0, 0.4, 0.4});
	classe[27] = classe_2(TRASH_1, &multi_mats[27], (t_vec3){0, 0.4, 0.5});
	classe[28] = classe_2(TRASH_2, &multi_mats[28], (t_vec3){0, 0.4, 0.8});
	classe[29] = classe_2(GUN, &multi_mats[29], (t_vec3){0, 0.4, 0.8});
	classe[30] = classe_2(SMG, &multi_mats[30], (t_vec3){0, 0.4, 0.8});
	classe[31] = classe_2(SHOTGUN, &multi_mats[31], (t_vec3){0, 0.4, 0.8});
	classe[32] = classe_2(REVOLVER, &multi_mats[32], (t_vec3){0, 0.4, 0.8});
	classe[33] = classe_2(NYAN_GUN, &multi_mats[33], (t_vec3){0, 0.8, 0.8});
	return (classe);
}
