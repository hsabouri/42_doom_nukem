...
/*   Updated: 2019/04/01 13:31:16 by lbougero         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				draw_map(t_game game, t_editor editor, t_color *buf)
{
	...
	draw_physic(game.player.my_entity.physic, editor, buf, MOONSTONE);
	draw_physic(game.player.my_entity.spawn, editor, buf, MUSTARD);
}
