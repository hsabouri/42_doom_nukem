...
t_lvl_error		sector_portal(t_portal *portals, size_t nportals,
				size_t nsectors);
...
t_lvl_error		check_texture(size_t ntextures,	t_img *textures, t_check_mat materials);
...
t_lvl_error		check_mat_entities(t_entity *entities, size_t nentities,
				t_array *mult_mats, size_t nmulti);
