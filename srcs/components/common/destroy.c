...
/*   Updated: 2019/06/22 16:07:12 by hsabouri         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	t_button_state *state = (t_button_state *)self->state;
...
{
	t_button_ft_state *state = (t_button_ft_state *)self->state;
...
{
	t_cb_button_state *state = (t_cb_button_state *)self->state;
